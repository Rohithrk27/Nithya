-- Canonical RPC refresh (friend + collab)
-- Purpose:
-- 1) Consolidate overlapping function definitions from prior migrations
-- 2) Provide one safe re-run migration for production repair
