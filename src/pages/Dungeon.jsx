...
import { ArrowLeft, Flame, Trophy, Skull } from 'lucide-react';
        ...
        <div className="flex items-center gap-3 py-2">
          ...
          <div>
            <h1 className="text-lg font-black tracking-widest text-white"
              ...
              {isDungeonMode ? '⚔ DUNGEON MODE ACTIVE' : 'DUNGEON SELECT'}
            </h1>
        ...
        {activeDungeon && (
          <div className="rounded-2xl p-5 space-y-4"
            ...
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-xs font-black tracking-widest" style={{ color: '#F87171' }}>ACTIVE DUNGEON RUN</span>
